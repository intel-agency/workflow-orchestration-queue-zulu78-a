...
class WorkItem(BaseModel):
    ...
    source_url: str = Field(..., description="Full URL to the GitHub issue")
    context_body: str = Field(default="", description="Issue body/context")
    target_repo_slug: str = Field(..., description="Target repository in owner/repo format")
    task_type: TaskType = Field(default=TaskType.IMPLEMENT, description="Type of work")
